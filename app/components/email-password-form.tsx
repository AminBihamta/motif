    ...
    <div className="relative mt-8 border-t-2 border-motif-black pt-6">
      ...
      {mode === "signup" ? (
        ...
        >
          ...
          <label className="block"><span className="mb-2 block text-[10px] font-black uppercase tracking-[0.18em]">Your name</span><input name="name" type="text" autoComplete="name" required className="w-full border-2 border-motif-black bg-transparent px-4 py-3 font-bold outline-none focus:shadow-[5px_5px_0_var(--color-motif-red)]" placeholder="Your name" /></label>
        ...
        <form onSubmit={handleSignIn} className="space-y-4">
          <label className="block"><span className="mb-2 block text-[10px] font-black uppercase tracking-[0.18em]">Email address</span><input name="email" type="email" autoComplete="email" required value={signInEmail} onChange={(event) => setSignInEmail(event.target.value)} className="w-full border-2 border-motif-black bg-transparent px-4 py-3 font-bold outline-none focus:shadow-[5px_5px_0_var(--color-motif-red)]" placeholder="yourname@example.com" /></label>
          <label className="block">
            ...
            <input name="password" type="password" autoComplete="current-password" required value={signInPassword} onChange={(event) => setSignInPassword(event.target.value)} className="w-full border-2 border-motif-black bg-transparent px-4 py-3 font-bold outline-none focus:shadow-[5px_5px_0_var(--color-motif-red)]" placeholder="Enter your password" />
          </label>
