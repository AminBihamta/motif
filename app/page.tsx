...
export const metadata: Metadata = {
  title: {
    absolute: "Motif — Find your vibe",
  },
  description:
    "Find what you actually like with Motif. Upload six images, get a named vibe, color DNA, and shoppable taste traits.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
...
export default function BoldHome() {
  ...
  const softwareJsonLd = {
    ...
    url: siteUrl,
    description:
      "AI taste profile tool that turns six images into a named vibe, color DNA, and shoppable traits.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD",
